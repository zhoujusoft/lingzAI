...
import lingzhou.agent.backend.business.monitor.service.ISysJobLogService;
import lingzhou.agent.backend.common.constants.Constants;
import lingzhou.agent.backend.common.utils.BeanUtils;
import lingzhou.agent.backend.common.utils.ExceptionUtil;
...
public abstract class AbstractQuartzJob implements Job {
    ...
    protected void after(JobExecutionContext context, SysJob sysJob, Exception e) {
        ...
        try {
            ...
            log.error("任务日志写入失败：jobName={}, error={}", sysJobLog.getJobName(), logEx.getMessage(), logEx);
        }
    }
