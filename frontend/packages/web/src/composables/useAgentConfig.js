...
export function getAgentDisplayName() {
    return (
        agentConfigState.template?.displayName || agentConfigState.template?.agentName || 'AI 助手'
    );
}
...
export function getAgentIcon() {
    return agentConfigState.template?.avatarUrl || agentConfigState.template?.icon || 'smart_toy';
}
...
export function getAgentOpeningMessage() {
    return agentConfigState.template?.openingMessage || '';
}
