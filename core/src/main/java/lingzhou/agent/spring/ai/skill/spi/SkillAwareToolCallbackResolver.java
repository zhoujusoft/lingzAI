 ...
 *
 * <p>This resolver works with {@code SkillAwareToolCallingManager} to enable dynamic tool execution.
 * When the LLM calls a tool, this resolver finds the tool callback from the SkillKit's active tools.
 *
...
public class SkillAwareToolCallbackResolver implements ToolCallbackResolver {
    ...
    private SkillAwareToolCallbackResolver(Builder builder) {
        this.skillKit = builder.skillKit;
    }
    ...
    public static class Builder {
        ...
        public SkillAwareToolCallbackResolver build() {
            return new SkillAwareToolCallbackResolver(this);
        }
    }
    ...
    public ToolCallback resolve(String toolName) {
        ...
        List<ToolCallback> defaultSkillTools = skillKit.getSkillLoaderTools();
