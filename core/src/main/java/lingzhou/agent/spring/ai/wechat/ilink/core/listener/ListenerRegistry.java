...
public class ListenerRegistry {
    ...
    private final List<OnDisconnectListener> disconnectListeners = new CopyOnWriteArrayList<OnDisconnectListener>();
    private final List<OnHeartbeatListener> heartbeatListeners = new CopyOnWriteArrayList<OnHeartbeatListener>();
    private final List<OnMessageListener> messageListeners = new CopyOnWriteArrayList<OnMessageListener>();
